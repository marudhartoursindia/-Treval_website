  ...
  return (
    <>
      ...
      >
        ...
        {/* 1. LINE Messenger Button */}
        <a
          href="https://line.me/ti/p/~japani_tour_guide"
          target="_blank"
          ...
          onMouseEnter={e => {
            ...
            (e.currentTarget as HTMLElement).style.boxShadow = "0 6px 20px rgba(6,199,85,0.6)";
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLElement).style.transform = "scale(1)";
            (e.currentTarget as HTMLElement).style.boxShadow = "0 4px 14px rgba(6,199,85,0.45)";
          }}
        >
          {/* LINE SVG Icon */}
