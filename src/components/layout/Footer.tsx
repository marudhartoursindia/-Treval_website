      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="flex space-x-4">
            <a href="https://www.instagram.com/marudhartoursindia/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-accent hover:text-primary transition-all duration-300 rounded-none" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/people/Marudhar-Tours-India/100067645391234/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-accent hover:text-primary transition-all duration-300 rounded-none" aria-label="Facebook">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
